...
pub static INSTRUCTION_CODE: [(Instruction, AddressingMode, ImpliedRegister); 256] = [
    ...
    (Instruction::LDY, AddressingMode::Immediate, ImpliedRegister::None),           // 0xA0
    (Instruction::LDA, AddressingMode::IndexedIndirect, ImpliedRegister::X),        // 0xA1
    ...
    (Instruction::LDY, AddressingMode::ZeroPage, ImpliedRegister::None),            // 0xA4
    ...
    (Instruction::LDY, AddressingMode::Absolute, ImpliedRegister::None),            // 0xAC
    ...
    (Instruction::LDA, AddressingMode::IndirectIndexed, ImpliedRegister::Y),        // 0xB1
    ...
    (Instruction::LDY, AddressingMode::ZeroPage, ImpliedRegister::X),               // 0xB4
    ...
    (Instruction::LDY, AddressingMode::Absolute, ImpliedRegister::X),               // 0xBC
