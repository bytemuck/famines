...
trait Adc {
    fn new_adc(carry: bool) -> Processor;
}

impl Adc for Processor {
    fn new_adc(carry: bool) -> Processor {
...
#[test]
fn adc_immediate() {
    let mut processor = Processor::new_adc(true);
...
#[test]
fn adc_immediate_carry_off() {
    let mut processor = Processor::new_adc(false);
...
#[test]
fn adc_absolute_x_crosses_carry_off() {
    let mut processor = Processor::new_adc(false);
...
#[test]
fn adc_absolute_y_crosses_carry_off() {
    let mut processor = Processor::new_adc(false);
...
#[test]
fn adc_indirect_y_crosses_carry_off() {
    let mut processor = Processor::new_adc(false);
