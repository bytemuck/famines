...
fn ora_immediate() {
    ...
    processor.memory[0xFFFC] = ORA_IMMEDIATE;
...
fn ora_zero_page() {
    ...
    processor.memory[0xFFFC] = ORA_ZERO_PAGE;
...
fn ora_zero_page_x() {
    ...
    processor.memory[0xFFFC] = ORA_ZERO_PAGE_X;
    processor.memory[0xFFFD] = 0x66;
...
fn ora_absolute() {
    ...
    processor.memory[0xFFFC] = ORA_ABSOLUTE;
    processor.memory[0xFFFD] = 0x66;
...
fn ora_absolute_x() {
    ...
    processor.memory[0xFFFC] = ORA_ABSOLUTE_X;
    processor.memory[0xFFFD] = 0x66;
    processor.memory[0xFFFE] = 0x66;
...
fn ora_absolute_y() {
    ...
    processor.memory[0xFFFC] = ORA_ABSOLUTE_Y;
    processor.memory[0xFFFD] = 0x66;
    processor.memory[0xFFFE] = 0x66;
    processor.memory[0x6676] = 0x42;
...
fn ora_indirect_x() {
    ...
    processor.memory[0xFFFC] = ORA_INDIRECT_X;
...
fn ora_indirect_y() {
    ...
    processor.memory[0xFFFC] = ORA_INDIRECT_Y;
    processor.memory[0xFFFD] = 0x02;
